...
//const uint16_t repeat, const uint8_t dutycycle
        ...
        sendGeneric(kEluxHdrMark, kEluxHdrSpace,
...
void IREluxAC::setMode(const uint8_t new_mode) {
  ...
  switch (mode) {
    ...
    case kEluxAuto: setTemp(25); break;
...
stdAc::fanspeed_t IREluxAC::toCommonFanSpeed(const uint8_t speed) {
  switch (speed) {
    ...
    case kEluxFanMed: return stdAc::fanspeed_t::kMedium;
